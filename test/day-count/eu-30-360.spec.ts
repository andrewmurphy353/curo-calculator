...
import EU30360 from "../../src/day-count/eu-30-360";
...
describe("EU30360.computeFactor", () => {
  const dc: Convention = new EU30360();
...
describe("EU30360(undefined, undefined) instance", () => {
  const dc: Convention = new EU30360(undefined, undefined);
  it("dayCountRef() to return NEIGHBOUR", () => {
    expect(EU30360.NEIGHBOUR).to.equal(dc.dayCountRef());
  });
...
describe("EU30360(undefined, true) instance", () => {
  const dc: Convention = new EU30360(undefined, true);
  it("usePostingDates() to return true by default", () => {
    expect(true).to.equal(dc.usePostingDates());
  });
...
describe("EU30360(false, undefined) instance", () => {
  const dc: Convention = new EU30360(false, undefined);
...
describe("EU30360(false, true) instance", () => {
  const dc: Convention = new EU30360(false, true);
  it("usePostingDates() to return false", () => {
    expect(false).to.equal(dc.usePostingDates());
  });
