...
describe("ActISDA(undefine, undefined, true|false) - IRR | XIRR", () => {
  ...
  it("IRR should return 0.121319 (decimal)", () => {
    assert.approximately(calc.solveRate(new ActISDA()), 0.121319, 0.0000005);
  });

  it("XIRR should return 0.128303 (decimal)", () => {
