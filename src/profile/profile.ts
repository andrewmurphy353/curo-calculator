...
export default class Profile {
  private readonly _cashFlows: CashFlow[]
  private _dayCount: Convention
  private readonly _drawdownPDate: Date
  private readonly _drawdownVDate: Date
   ...
   */
  constructor (cashFlows: CashFlow[], precision = 2) {
   ...
   */
  public updateValues (value: number, isRounded = false): number {
